/*
BEFORE YOU RUN THIS PROGRAM - RENAME FILE TO THE RESPECTIVE CLASS NAME
*/
...
public class TracingPaper extends Frame implements MouseListener, MouseMotionListener, WindowListener, ActionListener, TextListener{
  ...
  public TracingPaper() {
    ...
    startAngle.setEnabled(false);
    arcAngle.setEnabled(false);
    startAngle.addTextListener(this);
    arcAngle.addTextListener(this);
  ...
  public void textValueChanged(TextEvent event){
    ...
    try{
      ...
      int b =Integer.parseInt(arcAngle.getText());
      if(b == 0){
        arc.setEnabled(false);
      }else{
        arc.setEnabled(true);
    ...
    {
      System.out.println("only integers are allowed:" + exp);
    }
  ...
  public void actionPerformed(final ActionEvent e) {
    ...
    try {
      ...
      if (clickedButton == "}") { // SAVE BUTTON SETTING
  ...
  public void enableButtons(boolean val){
    ...
    poly.setEnabled(val);
    save.setEnabled(val);
    clearlast.setEnabled(val);

    startAngle.setEnabled(val);
    arcAngle.setEnabled(val);
    startAngle.setText("0");
    arcAngle.setText("0");
  ...
  public void paint(final Graphics g) {
    ...
    try {
      ...
      //showing author name and instructions
       g.setColor(Color.BLACK);
        g2D.setStroke(new BasicStroke(0F));
        g.drawString("~ Developer : Nitin Kumar, email: imkr.nitin@gmail.com", 350, 550);
